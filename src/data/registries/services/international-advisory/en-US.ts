...
import { definePageData, type InternationalAdvisoryData } from 'types/pages'
import type { RegistryFor } from 'types/transformer'

export const headerProps: RegistryFor<HeaderProps, 'internationalAdvisory'> = {
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { label: 'International Advisory', href: 'services/international-advisory', isActive: true }
]

export const heroProps: RegistryFor<Hero4Props, 'internationalAdvisory'> = {
  titleKey: 'hero.title',
...
export const ctaProps: RegistryFor<CtaProps, 'internationalAdvisory'> = {
  titleKey: 'cta.title',
  buttonTitle: 'Request a Consultation'
}

const serviceSet: RegistryFor<AmbitService, 'internationalAdvisory'>[] = [
  {
    id: 1,
...
const serviceProps: RegistryFor<ServiceCallOutProps, 'internationalAdvisory'> = {
  titleKey: 'services.title',
  ambitServiceSetKey: serviceSet
}

export const usInternationalAdvisoryData: InternationalAdvisoryData = definePageData<InternationalAdvisoryData>({
...
export default usInternationalAdvisoryData
