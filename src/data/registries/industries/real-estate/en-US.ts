...
import { definePageData, type RealEstateData } from 'types/pages'
import type { RegistryFor } from 'types/transformer'

export const headerProps: RegistryFor<HeaderProps, 'real-estate'> = {
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { label: 'Real Estate & Property Management', href: 'industries/real-estate', isActive: true }
]

export const heroProps: RegistryFor<Hero4Props, 'real-estate'> = {
  titleKey: 'hero.title',
...
export const ctaProps: RegistryFor<CtaProps, 'real-estate'> = {
  titleKey: 'cta.title',
  buttonTitle: 'Request a Consultation'
}

// Challenge props
const challengeSet: RegistryFor<AmbitService, 'real-estate'>[] = [
  {
    id: 1,
...
const challengesProps: RegistryFor<ServiceCallOutProps, 'real-estate'> = {
  titleKey: 'challenges.title',
  ambitServiceSetKey: challengeSet
}

// services props
const serviceSet: RegistryFor<AmbitService, 'real-estate'>[] = [
  {
    id: 1,
...
const serviceProps: RegistryFor<ServiceCallOutProps, 'real-estate'> = {
  titleKey: 'services.title',
  ambitServiceSetKey: serviceSet
}

export const usRealEstateData: RealEstateData = definePageData<RealEstateData>({
...
export default usRealEstateData
