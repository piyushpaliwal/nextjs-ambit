...
import { definePageData, type StartupsData } from 'types/pages'
import type { RegistryFor } from 'types/transformer'

export const headerProps: RegistryFor<HeaderProps, 'startups'> = {
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { label: 'Startups & Venture-Backed Companies', href: 'industries/startups', isActive: true }
]

export const heroProps: RegistryFor<Hero4Props, 'startups'> = {
  titleKey: 'hero.title',
...
export const ctaProps: RegistryFor<CtaProps, 'startups'> = {
  titleKey: 'cta.title',
  buttonTitle: 'Request a Consultation'
}

// Challenge props
const challengeSet: RegistryFor<AmbitService, 'startups'>[] = [
  {
    id: 1,
...
const challengesProps: RegistryFor<ServiceCallOutProps, 'startups'> = {
  titleKey: 'challenges.title',
  ambitServiceSetKey: challengeSet
}

// services props
const serviceSet: RegistryFor<AmbitService, 'startups'>[] = [
  {
    id: 1,
...
const serviceProps: RegistryFor<ServiceCallOutProps, 'startups'> = {
  titleKey: 'services.title',
  ambitServiceSetKey: serviceSet
}

export const usStartupsData: StartupsData = definePageData<StartupsData>({
