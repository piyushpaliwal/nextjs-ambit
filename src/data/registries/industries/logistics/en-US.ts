...
import { definePageData, type LogisticsData } from 'types/pages'
import type { RegistryFor } from 'types/transformer'

export const headerProps: RegistryFor<HeaderProps, 'logistics'> = {
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { label: 'Logistics & Transportation', href: 'industries/logistics', isActive: true }
]

export const heroProps: RegistryFor<Hero4Props, 'logistics'> = {
  titleKey: 'hero.title',
...
export const ctaProps: RegistryFor<CtaProps, 'logistics'> = {
  titleKey: 'cta.title',
  buttonTitle: 'Request a Consultation'
}

// Challenge props
const challengeSet: RegistryFor<AmbitService, 'logistics'>[] = [
  {
    id: 1,
...
const challengesProps: RegistryFor<ServiceCallOutProps, 'logistics'> = {
  titleKey: 'challenges.title',
  ambitServiceSetKey: challengeSet
}

// services props
const serviceSet: RegistryFor<AmbitService, 'logistics'>[] = [
  {
    id: 1,
...
const serviceProps: RegistryFor<ServiceCallOutProps, 'logistics'> = {
  titleKey: 'services.title',
  ambitServiceSetKey: serviceSet
}

export const usLogisticsData: LogisticsData = definePageData<LogisticsData>({
...
export default usLogisticsData
