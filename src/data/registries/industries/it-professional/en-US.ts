...
import { definePageData, type ItProfessionalData } from 'types/pages'
import type { RegistryFor } from 'types/transformer'

export const headerProps: RegistryFor<HeaderProps, 'it-professional'> = {
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { label: 'IT Contractors & Professional Services', href: 'industries/it-professional', isActive: true }
]

export const heroProps: RegistryFor<Hero4Props, 'it-professional'> = {
  titleKey: 'hero.title',
...
export const ctaProps: RegistryFor<CtaProps, 'it-professional'> = {
  titleKey: 'cta.title',
  buttonTitle: 'Request a Consultation'
}

// Challenge props
const challengeSet: RegistryFor<AmbitService, 'it-professional'>[] = [
  {
    id: 1,
...
const challengesProps: RegistryFor<ServiceCallOutProps, 'it-professional'> = {
  titleKey: 'challenges.title',
  ambitServiceSetKey: challengeSet
}

// services props
const serviceSet: RegistryFor<AmbitService, 'it-professional'>[] = [
  {
    id: 1,
...
const serviceProps: RegistryFor<ServiceCallOutProps, 'it-professional'> = {
  titleKey: 'services.title',
  ambitServiceSetKey: serviceSet
}

export const usItProfessionalData: ItProfessionalData = definePageData<ItProfessionalData>({
...
export default usItProfessionalData
