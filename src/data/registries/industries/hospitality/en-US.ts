...
import { definePageData, type HospitalityData } from 'types/pages'
import type { RegistryFor } from 'types/transformer'

export const headerProps: RegistryFor<HeaderProps, 'hospitality'> = {
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { label: 'Hospitality (Hotels, Restaurants, Cafes)', href: 'industries/hospitality', isActive: true }
]

export const heroProps: RegistryFor<Hero4Props, 'hospitality'> = {
  titleKey: 'hero.title',
...
export const ctaProps: RegistryFor<CtaProps, 'hospitality'> = {
  titleKey: 'cta.title',
  buttonTitle: 'Request a Consultation'
}

// Challenge props
const challengeSet: RegistryFor<AmbitService, 'hospitality'>[] = [
  {
    id: 1,
...
const challengesProps: RegistryFor<ServiceCallOutProps, 'hospitality'> = {
  titleKey: 'challenges.title',
  ambitServiceSetKey: challengeSet
}

// services props
const serviceSet: RegistryFor<AmbitService, 'hospitality'>[] = [
  {
    id: 1,
...
const serviceProps: RegistryFor<ServiceCallOutProps, 'hospitality'> = {
  titleKey: 'services.title',
  ambitServiceSetKey: serviceSet
}

export const usHospitalityData: HospitalityData = definePageData<HospitalityData>({
...
export default usHospitalityData
