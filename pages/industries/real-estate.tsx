...
import type { RealEstateData } from 'types/pages'
import { getI18nStaticProps } from 'utils/i18n-ssr'

interface Props {
  rawData: RealEstateData & { footerData: FooterProps }
}

export const getStaticProps = getI18nStaticProps('industries/real-estate', ['real-estate'])

const RealEstate: NextPage<Props> = ({ rawData }) => {
