...
import type { ItProfessionalData } from 'types/pages'
import { getI18nStaticProps } from 'utils/i18n-ssr'

interface Props {
  rawData: ItProfessionalData & { footerData: FooterProps }
}

export const getStaticProps = getI18nStaticProps('industries/it-professional', ['it-professional'])

const ItProfessional: NextPage<Props> = ({ rawData }) => {
